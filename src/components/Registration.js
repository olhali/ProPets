        ...
        return (
            <div>
                 <form name='registration' action='#' method='POST' >
                        ...
                        <input id='user_password' type='password' name='password' title='Password must have at least 8 characters, including letters and numbers or a special character' placeholder='Enter your password' autoComplete='off' required className={style.no_frame} onChange={(event) => {this.props.handlePassword(event)}} onKeyUp={this.props.checkPasswords}/><br/>

                        <label htmlFor='repeat_password' className={style.label}>Repeat password:</label>
                        <input id='repeat_password' type='password' name='repeatPassword' title='Please re-enter your password' placeholder='Re-enter your password' autoComplete='off' required className={style.no_frame} onChange={(event) => {this.props.handleConfirmPassword(event)}} onKeyUp={this.props.checkPasswords}/><br/>

                        {this.props.validationLabel}
                        {/*<span className={style.message} id='message'></span>*/}
                 </form>
            </div>
        );
    }
